...
def download_daily_data(
    ...
    upload_to_server : bool, optional
        If True, upload the data to the server, by default False
    """
    ...
    # TODO: Do we always want this buffer?
    # The buffer is used to make sure we get packets grouped together appropriately
    # even if they cross the day boundaries
    ...
    for date in unique_dates:
        ...
        # NOTE: We are buffering these days by 30 minutes on each side of the day
        #       There may be overlapping data in the files because of this
        daily_start_time = datetime.datetime.combine(date, datetime.time.min) - buffer
        daily_end_time = datetime.datetime.combine(date, datetime.time.max) + buffer
